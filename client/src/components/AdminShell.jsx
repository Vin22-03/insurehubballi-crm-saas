...
const navItems = [
  { key: "dashboard", label: "Dashboard", path: "/admin", icon: <FiHome /> },
  { key: "advisors", label: "Advisors", path: "/admin/advisors", icon: <FiUsers /> },
  { key: "templates", label: "Templates", path: "/admin/templates", icon: <FiFileText /> },
